...
const Card: React.FC<Card> = ({selected, title, description}) => {
   ...
   return <motion.button onClick={()=> console.log("clicked")}
           className="group flex-1 justify-start hover:text-gray-400 text-left items-start lg:mb-0 rounded-xl border border-neutral-400 px-5 py-4 transition-colors duration-300 dark:border-neutral-600 hover:border-gray-500 hover:bg-neutral-300 hover:dark:border-neutral-400 hover:dark:bg-neutral-600/30">
