	...
	return (
		...
		<BaseLayout>
			<main className="p-1 lg:h-screen lg:min-h-screen min-w-screen flex flex-col items-center justify-center">
				...
				<div className="fixed mr-10 left-0 top-0 flex w-full items-center justify-center border-b-[0.5px] border-gray-400 pb-5 pt-5
										backdrop-saturate-50 backdrop-blur-3xl dark:border-neutral-700 dark:from-inherit">
					<Text fontSize={FontSize.md} bold
					      className="tracking-wider text-neutral-800 dark:text-neutral-300 font-space">Light Chen's Resume</Text>
				</div>
				
				<div className={"flex flex-col mt-28 lg:mt-20 items-center"}>
					<Image
						className={""}
					...
					<div
						className="flex flex-col lg:flex-row items-center lg:min-w-[75%] lg:max-w-5xl lg:w-auto lg:p-0 mt-8">
						<Text fontSize={FontSize.sm}
				...
				<div className="flex flex-col gap-y-4 w-[90%] lg:max-w-[1280px] p-2 lg:p-0 mt-10 mb-12">
					...
					<div className={"flex flex-row items-center mt-6 lg:mt-8"}>
						...
						<h2
							className={`font-space ml-1.5 text-xl tracking-wider pr-4 dark:text-neutral-300 text-neutral-700`}>Works</h2>
